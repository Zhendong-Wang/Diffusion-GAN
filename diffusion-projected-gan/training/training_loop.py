...
def training_loop(
    ...
    while True:
        ...
        fields += [f"augment {training_stats.report0('Progress/augment', float(D.feature_network.diffusion.p)):.3f}"]
        fields += [f"T {training_stats.report0('Progress/augment_T', float(D.feature_network.diffusion.num_timesteps))}"]
